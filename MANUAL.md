# Manual Setup Steps for Minions Agents
...
Go to **GitHub → mxn2020/minions-agents → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-agents` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-agents-web`
- **GitHub repo**: `mxn2020/minions-agents`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `agents.minions.wtf`

### Documentation
- **Netlify site name**: `minions-agents-docs`
- **GitHub repo**: `mxn2020/minions-agents`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `agents.minions.help`

### Blog
- **Netlify site name**: `minions-agents-blog`
- **GitHub repo**: `mxn2020/minions-agents`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `agents.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `agents.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `agents.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `agents.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-agents/sdk`](https://www.npmjs.com/package/@minions-agents/sdk)
- CLI: [`@minions-agents/cli`](https://www.npmjs.com/package/@minions-agents/cli)
...
Your package: [`minions-agents`](https://pypi.org/project/minions-agents/)
...
| Item | Value |
|------|-------|
| Project | `minions-agents` |
| SDK (npm) | `@minions-agents/sdk` |
| CLI (npm) | `@minions-agents/cli` |
| Python (PyPI) | `minions-agents` |
| GitHub | `github.com/mxn2020/minions-agents` |
| Docs domain | `agents.minions.help` |
| Blog domain | `agents.minions.blog` |
| App domain | `agents.minions.wtf` |
