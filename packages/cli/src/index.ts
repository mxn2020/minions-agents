...
/**
 * @minions-agents/cli — CLI for Minions agents
 *
...
import { customTypes } from '@minions-agents/sdk';
...
program.name('agents').description('Agent definitions, runs, traces, and approval requests for the agent fleet').version('0.1.0');

program.command('info').description('Show project info').action(() => {
    console.log(chalk.bold('Minions agents'));
    console.log(chalk.dim('Agent definitions, runs, traces, and approval requests for the agent fleet'));
    console.log('');
    console.log(`  SDK:    ${chalk.cyan('@minions-agents/sdk')}`);
    console.log(`  CLI:    ${chalk.cyan('@minions-agents/cli')}`);
    console.log(`  Python: ${chalk.cyan('minions_agents')}`);
